(function () {
  ...
  const WARM_LINES = [
    { text: { en: 'Her name is Momo.', zh: '她叫莫莫。', pt: 'Ela se chama Momo.', es: 'Se llama Momo.' }, speed: 50, wait: 800 },
    { text: { en: 'They live deep in the Amazon.', zh: '她们住在亚马逊的深处。', pt: 'Vivem no fundo da Amazônia.', es: 'Viven en lo profundo del Amazonas.' }, speed: 45, wait: 700 },
    { text: { en: 'The water is still.', zh: '水面平静无波。', pt: 'A água está parada.', es: 'El agua está quieta.' }, speed: 50, wait: 800 },
    { text: { en: 'She has two cubs.', zh: '她有两只幼崽。', pt: 'Ela tem dois filhotes.', es: 'Tiene dos cachorros.' }, speed: 50, wait: 700 },
    { text: { en: 'Mira, the older one. She loves to climb.', zh: '米拉，姐姐。她爱攀爬。', pt: 'Mira, a mais velha. Adora escalar.', es: 'Mira, la mayor. Le encanta trepar.' }, speed: 45, wait: 800 },
    { text: { en: "{cub}, the younger. He's afraid of the river.", zh: '{cub}，弟弟。他怕河水。', pt: '{cub}, o mais novo. Tem medo do rio.', es: '{cub}, el menor. Le teme al río.' }, speed: 45, wait: 800 },
    { text: { en: 'She nudges him to the water’s edge. He freezes, afraid.', zh: '她把他轻轻推到水边。他僵住了，害怕。', pt: 'Ela o empurra de leve até a beira da água. Ele congela, com medo.', es: 'Ella lo empuja con suavidad hasta la orilla. Él se queda inmóvil, con miedo.' }, speed: 50, wait: 700, gate: 'feed' },
    { text: { en: 'He drinks at last. The river does not take him.', zh: '他终于喝上了水。河水没有带走他。', pt: 'Enfim ele bebe. O rio não o leva.', es: 'Por fin bebe. El río no se lo lleva.' }, speed: 46, wait: 900 },
    { text: { en: 'For the first time, he trusted the water — because you stayed.', zh: '他第一次，信任了这条河 —— 因为你陪着他。', pt: 'Pela primeira vez, ele confiou na água — porque você ficou.', es: 'Por primera vez, confió en el agua — porque tú te quedaste.' }, speed: 46, wait: 1100 },
    { text: { en: 'Momo teaches them how to listen.', zh: '莫莫教它们如何倾听。', pt: 'Momo lhes ensina a escutar.', es: 'Momo les enseña a escuchar.' }, speed: 50, wait: 700 },
    { text: { en: 'How to wait. How to stay.', zh: '如何等待。如何留守。', pt: 'A esperar. A permanecer.', es: 'A esperar. A quedarse.' }, speed: 55, wait: 1200 },
    { text: { en: "She doesn't know you're watching.", zh: '她不知道你正在窥视。', pt: 'Ela não sabe que você está observando.', es: 'No sabe que la estás observando.' }, speed: 50, wait: 500 },
  ];
  ...
  const HUNTER_LINES = [
    { text: { en: 'You watched them for a long time, through the leaves.', zh: '你透过枝叶，看了它们很久。', pt: 'Você os observou por muito tempo, por entre as folhas.', es: 'Los observaste largo rato, entre las hojas.' }, speed: 52, wait: 1300 },
    { text: { en: 'The hands holding the branches apart are holding a rifle.', zh: '那双拨开枝叶的手，也握着一支枪。', pt: 'As mãos que afastam os galhos seguram um rifle.', es: 'Las manos que apartan las ramas sostienen un rifle.' }, speed: 48, wait: 1600 },
    { text: { en: 'You are a hunter.', zh: '你是个猎人。', pt: 'Você é um caçador.', es: 'Eres un cazador.' }, speed: 60, wait: 1200 },
    { text: { en: 'You came for the skin.', zh: '你为皮毛而来。', pt: 'Você veio pela pele.', es: 'Viniste por la piel.' }, speed: 55, wait: 1000 },
    { text: { en: 'It pays well.', zh: '它能卖个好价钱。', pt: 'Paga bem.', es: 'Paga bien.' }, speed: 70, wait: 1500 },
  ];
  ...
  const AFTERMATH_LINES = [
    { text: { en: "Momo doesn't move.", zh: '莫莫一动不动。', pt: 'Momo não se move.', es: 'Momo no se mueve.' }, speed: 55, wait: 1500 },
    { text: { en: 'Sol calls for her.', zh: '索尔呼唤着她。', pt: 'Sol a chama.', es: 'Sol la llama.' }, speed: 50, wait: 1500, sound: 'cry' },
    { text: { en: 'Mira waits by the water.', zh: '米拉在水边等待。', pt: 'Mira espera junto à água.', es: 'Mira espera junto al agua.' }, speed: 50, wait: 1200 },
    { text: { en: 'The night comes.', zh: '夜幕降临。', pt: 'A noite chega.', es: 'Llega la noche.' }, speed: 60, wait: 1500 },
    { text: { en: 'She taught them to wait.', zh: '她曾教它们等待。', pt: 'Ela os ensinou a esperar.', es: 'Ella les enseñó a esperar.' }, speed: 50, wait: 2000, big: true },
    { text: { en: 'They are still waiting.', zh: '它们仍在等待。', pt: 'Eles ainda esperam.', es: 'Siguen esperando.' }, speed: 55, wait: 2500, big: true },
  ];

  /* Scene 8 — the cubs left behind. Same rainforest, only the lone cub. */
  const CUB_LINES = [
    { text: { en: '{cub} crossed the river. The one he was always afraid of.', zh: '{cub}渡过了那条河 —— 他一直害怕的那条。', pt: '{cub} atravessou o rio. Aquele de que sempre teve medo.', es: '{cub} cruzó el río. El que siempre le dio miedo.' }, speed: 50, wait: 1500 },
    { text: { en: 'No one was left to carry him across.', zh: '再没有谁能驮他过去了。', pt: 'Não havia mais ninguém para levá-lo até o outro lado.', es: 'Ya no quedaba nadie para cruzarlo al otro lado.' }, speed: 55, wait: 1800 },
    { text: { en: 'Mira climbed to the highest branch — the way her mother taught her.', zh: '米拉爬上了最高的枝头 —— 像母亲教过她的那样。', pt: 'Mira subiu até o galho mais alto — como a mãe lhe ensinou.', es: 'Mira trepó hasta la rama más alta — como le enseñó su madre.' }, speed: 48, wait: 1500 },
    { text: { en: 'She watched the trees until dark. No one came.', zh: '她望着林子，直到天黑。没有人来。', pt: 'Ela vigiou as árvores até escurecer. Ninguém veio.', es: 'Vigiló los árboles hasta el anochecer. Nadie vino.' }, speed: 52, wait: 2400, big: true },
    { text: { en: 'Mira waited three more nights. Then the branch was empty.', zh: '米拉又守了三个夜晚。然后，那根枝头空了。', pt: 'Mira esperou mais três noites. Depois, o galho ficou vazio.', es: 'Mira esperó tres noches más. Luego, la rama quedó vacía.' }, speed: 50, wait: 2000 },
    { text: { en: 'A cub alone rarely lasts a single season.', zh: '一只落单的幼崽，很少能熬过一整个旱季。', pt: 'Um filhote sozinho raramente sobrevive a uma estação.', es: 'Un cachorro solo rara vez sobrevive una temporada.' }, speed: 52, wait: 1900 },
    { text: { en: '{cub} stayed by the river — the water she once nudged him toward.', zh: '{cub}留在了河边 —— 那片她曾一点点把他推向的水。', pt: '{cub} ficou junto ao rio — a água para a qual ela um dia o empurrou.', es: '{cub} se quedó junto al río — el agua hacia la que ella una vez lo empujó.' }, speed: 48, wait: 1700 },
    { text: { en: 'Thin, and alone. But still here.', zh: '瘦弱，孤单。但还活着。', pt: 'Magro, e sozinho. Mas ainda aqui.', es: 'Flaco, y solo. Pero todavía aquí.' }, speed: 50, wait: 1800 },
    { text: { en: 'A cub almost never makes it without a mother. {cub} is the almost — still carrying the name you gave him.', zh: '没有母亲的幼崽，几乎无一幸免。{cub}就是那个「几乎」—— 仍带着你给他的名字。', pt: 'Um filhote quase nunca sobrevive sem a mãe. {cub} é o quase — ainda carregando o nome que você lhe deu.', es: 'Un cachorro casi nunca lo logra sin su madre. {cub} es el casi — todavía lleva el nombre que le diste.' }, speed: 48, wait: 2600, big: true },
  ];
  ...
  const PELT_LINES = [
    { text: { en: 'Her skin was lifted from where she fell.', zh: '她的皮，从她倒下的地方被剥走。', pt: 'A pele dela foi arrancada de onde ela caiu.', es: 'Le arrancaron la piel donde cayó.' }, speed: 50, wait: 1600 },
    { text: { en: 'It was sold at a stall — beside the ivory, the cages.', zh: '它被卖到一个摊位 —— 挨着象牙，挨着鸟笼。', pt: 'Foi vendida numa banca — ao lado do marfim, das gaiolas.', es: 'Se vendió en un puesto — junto al marfil, a las jaulas.' }, speed: 48, wait: 1600 },
    { text: { en: 'Now it hangs on a wall, in a house she will never see.', zh: '如今它挂在一面墙上，在一座她永远见不到的房子里。', pt: 'Agora está pendurada numa parede, numa casa que ela nunca verá.', es: 'Ahora cuelga de una pared, en una casa que ella nunca verá.' }, speed: 48, wait: 1800 },
    { text: { en: 'It paid well.', zh: '它，确实卖了个好价钱。', pt: 'Pagou bem.', es: 'Pagó bien.' }, speed: 70, wait: 2400, big: true },
    { text: { en: "'It's beautiful,' a guest says. 'Is it real?'", zh: '「真漂亮，」一位客人说。「是真的吗？」', pt: '«É linda», diz um convidado. «É de verdade?»', es: '«Es preciosa», dice un invitado. «¿Es de verdad?»' }, speed: 50, wait: 1700 },
    { text: { en: "'Of course it is,' the owner smiles.", zh: '「当然是真的，」主人微笑着。', pt: '«Claro que é», sorri o dono.', es: '«Claro que sí», sonríe el dueño.' }, speed: 50, wait: 1800 },
    { text: { en: 'No one in this bright room knows she ever had a name.', zh: '这间明亮的屋子里，没有人知道她曾有过一个名字。', pt: 'Ninguém nesta sala iluminada sabe que ela teve um nome.', es: 'Nadie en esta sala luminosa sabe que ella tuvo un nombre.' }, speed: 48, wait: 1900 },
    { text: { en: 'The hunter pulled the trigger. But the wall is the reason.', zh: '猎人扣下了扳机。但那面墙，才是原因。', pt: 'O caçador puxou o gatilho. Mas a parede é o motivo.', es: 'El cazador apretó el gatillo. Pero la pared es la razón.' }, speed: 48, wait: 2600, big: true },
  ];
  ...
  const GUARD_LINES = [
    { text: { en: 'This time, you are not the one with the rifle.', zh: '这一次，握枪的不是你。', pt: 'Desta vez, não é você quem está com o rifle.', es: 'Esta vez, no eres tú quien lleva el rifle.' }, speed: 52, wait: 1400 },
    { text: { en: 'You are a guardian of this forest — a ranger, a child of this land.', zh: '你是这片森林的守护者 —— 一名护林员，这片土地的孩子。', pt: 'Você é um guardião desta floresta — um guarda florestal, um filho desta terra.', es: 'Eres un guardián de este bosque — un guardabosques, un hijo de esta tierra.' }, speed: 46, wait: 1600 },
    { text: { en: 'When the hunters come, you do not aim at the jaguars. You shield them.', zh: '当猎人来时，你不瞄准美洲豹。你护住它们。', pt: 'Quando os caçadores vêm, você não mira nas onças. Você as protege.', es: 'Cuando llegan los cazadores, no apuntas a los jaguares. Los proteges.' }, speed: 48, wait: 1800 },
  ];
  ...
  const GUARD_WARM_LINES = [
    { text: { en: 'Momo and her cubs are here — alive, the same as before.', zh: '莫莫和她的幼崽都在 —— 活着，和从前一样。', pt: 'Momo e seus filhotes estão aqui — vivos, como antes.', es: 'Momo y sus cachorros están aquí — vivos, igual que antes.' }, speed: 48, wait: 1500 },
    { text: { en: 'Only this time, someone watches the tree line for them.', zh: '只是这一次，有人替它们守着林线。', pt: 'Só que desta vez, alguém vigia a mata por eles.', es: 'Solo que esta vez, alguien vigila la linde del bosque por ellos.' }, speed: 50, wait: 1700 },
  ];
  const GUARD_HUNT_LINES = [
    { text: { en: 'The hunter comes, the way he always does.', zh: '猎人来了，一如既往。', pt: 'O caçador vem, como sempre vem.', es: 'El cazador viene, como siempre lo hace.' }, speed: 52, wait: 1400 },
    { text: { en: 'This time you do not raise a rifle — you step into the clearing.', zh: '这一次，你没有举枪 —— 你走进了那片空地。', pt: 'Desta vez você não ergue um rifle — você entra na clareira.', es: 'Esta vez no levantas un rifle — entras en el claro.' }, speed: 48, wait: 1600 },
    { text: { en: 'You make yourself seen. You make him turn back.', zh: '你让自己被看见。你让他掉头离开。', pt: 'Você se faz ver. Você o faz dar meia-volta.', es: 'Te haces ver. Haces que se dé la vuelta.' }, speed: 50, wait: 1700 },
  ];
  const GUARD_END_LINES = [
    { text: { en: 'The cubs grow. Sol learns the river; Mira learns the canopy.', zh: '幼崽长大了。索尔学会了河，米拉学会了树冠。', pt: 'Os filhotes crescem. Sol aprende o rio; Mira aprende as copas.', es: 'Los cachorros crecen. Sol aprende el río; Mira aprende las copas.' }, speed: 48, wait: 1600 },
    { text: { en: 'Because someone stayed between them and the gun.', zh: '因为有人，一直挡在它们和枪口之间。', pt: 'Porque alguém ficou entre eles e a arma.', es: 'Porque alguien se interpuso entre ellos y el arma.' }, speed: 50, wait: 1800 },
    { text: { en: 'Every six seconds, one is lost. But not this one. Not today.', zh: '每六秒，就有一个消逝。但不是这一只。不是今天。', pt: 'A cada seis segundos, um se perde. Mas não este. Não hoje.', es: 'Cada seis segundos, uno se pierde. Pero no este. No hoy.' }, speed: 52, wait: 2600, big: true },
  ];

  /* Scene 15 · 支线① — She was once a cub too (Momo's own flashback). */
  const SUBLINE1_LINES = [
    { text: { en: 'Long before Sol. Long before Mira.', zh: '在索尔出生之前。在米拉出生之前。', pt: 'Muito antes de Sol. Muito antes de Mira.', es: 'Mucho antes de Sol. Mucho antes de Mira.' }, speed: 50, wait: 1400 },
    { text: { en: 'Momo was small once, too.', zh: '莫莫，也曾经那么小。', pt: 'Momo também já foi pequena.', es: 'Momo también fue pequeña una vez.' }, speed: 52, wait: 1500 },
    { text: { en: 'Her own mother led her to this same water.', zh: '她自己的母亲，曾把她领到这同一片水边。', pt: 'A própria mãe a levou a esta mesma água.', es: 'Su propia madre la llevó a esta misma agua.' }, speed: 48, wait: 1500 },
    { text: { en: 'Nudged her in, the day she was afraid of it.', zh: '在她怕水的那天，把她一点点推进水里。', pt: 'Empurrou-a para dentro, no dia em que ela teve medo.', es: 'La empujó al agua, el día que le tuvo miedo.' }, speed: 48, wait: 1600 },
    { text: { en: 'The forest raised her, the way it raises them all.', zh: '这片森林养大了她 —— 像它养大每一个孩子。', pt: 'A floresta a criou, como cria todos eles.', es: 'El bosque la crió, como los cría a todos.' }, speed: 48, wait: 1700 },
    { text: { en: 'One generation, then the next. The same green, the same water — and the same crosshair, waiting in the leaves.', zh: '一代，又一代。同一片绿，同一片水 —— 还有枝叶里，同一个等待着的准星。', pt: 'Uma geração, depois a seguinte. O mesmo verde, a mesma água — e a mesma mira, à espreita entre as folhas.', es: 'Una generación, luego la siguiente. El mismo verde, la misma agua — y la misma mira, esperando entre las hojas.' }, speed: 46, wait: 2600, big: true },
  ];

  /* Scene 20 · 支线② — Years later: Sol grown, the circle closes. */
  const SUBLINE2_LINES = [
    { text: { en: 'Years pass. The water is still here.', zh: '很多年过去了。这片水，还在。', pt: 'Os anos passam. A água continua aqui.', es: 'Pasan los años. El agua sigue aquí.' }, speed: 50, wait: 1300 },
    { text: { en: '{cub} grew up. He never left this place.', zh: '{cub}长大了。他再没离开过这里。', pt: '{cub} cresceu. Nunca deixou este lugar.', es: '{cub} creció. Nunca dejó este lugar.' }, speed: 48, wait: 1500 },
    { text: { en: 'Now there is a smaller one at his side — his own.', zh: '如今他身边，也有了一只更小的 —— 他自己的孩子。', pt: 'Agora há um menor ao seu lado — seu próprio filho.', es: 'Ahora hay uno más pequeño a su lado — su propio hijo.' }, speed: 48, wait: 1500 },
    { text: { en: 'Afraid of the water — just as he once was.', zh: '怕水 —— 就像当年的他。', pt: 'Com medo da água — assim como ele um dia teve.', es: 'Con miedo del agua — igual que él alguna vez.' }, speed: 48, wait: 1500 },
    { text: { en: 'He nudges the little one toward the edge. The circle closes.', zh: '他把那小家伙，一点点推向水边。一个圈，就此合上。', pt: 'Ele empurra o pequeno até a beira. O círculo se fecha.', es: 'Empuja al pequeño hacia la orilla. El círculo se cierra.' }, speed: 48, wait: 1700 },
    { text: { en: 'And in the trees — where you once stood — something is watching again.', zh: '而在林子深处 —— 你曾站立的地方 —— 有什么，又在注视。', pt: 'E entre as árvores — onde você um dia esteve — algo observa de novo.', es: 'Y entre los árboles — donde tú una vez estuviste — algo observa de nuevo.' }, speed: 46, wait: 2600, big: true },
  ];

  /* Ending「空枪」— you lowered the gun and walked away; the clock didn't stop. */
  const EMPTYGUN_LINES = [
    { text: { en: 'You lowered the rifle. You backed into the trees.', zh: '你放下了枪。你退回了林子里。', pt: 'Você baixou o rifle. Recuou para o meio das árvores.', es: 'Bajaste el rifle. Retrocediste entre los árboles.' }, speed: 50, wait: 1500 },
    { text: { en: 'She never knew you were there. You told yourself you saved her.', zh: '她始终不知道你来过。你告诉自己：你救了她。', pt: 'Ela nunca soube que você esteve lá. Você disse a si mesmo que a salvou.', es: 'Ella nunca supo que estuviste allí. Te dijiste que la salvaste.' }, speed: 48, wait: 1600 },
    { text: { en: 'But the skin still pays — and down the river, another rifle was already raised.', zh: '可那张皮还是值钱 —— 而沿着河往下，另一支枪，早已举起。', pt: 'Mas a pele ainda paga — e rio abaixo, outro rifle já estava erguido.', es: 'Pero la piel todavía paga — y río abajo, ya se alzaba otro rifle.' }, speed: 48, wait: 1700 },
    { text: { en: 'Six seconds. Then six more. The clock did not care that you walked away.', zh: '六秒。又六秒。那座钟，不在乎你转身离开。', pt: 'Seis segundos. Depois mais seis. O relógio não se importou que você fosse embora.', es: 'Seis segundos. Luego seis más. Al reloj no le importó que te marcharas.' }, speed: 48, wait: 1800 },
    { text: { en: 'You saved this one. You did not save the rate.', zh: '你救了这一只。你没能救下那个速率。', pt: 'Você salvou esta. Não salvou o ritmo.', es: 'Salvaste a esta. No salvaste el ritmo.' }, speed: 46, wait: 2400, big: true },
  ];

  /* Ending「长夜」— you stayed; the orphaned cubs survive their first night. */
  const LONGNIGHT_LINES = [
    { text: { en: 'You stayed. You did not follow the money.', zh: '你留了下来。你没有追着钱走。', pt: 'Você ficou. Não foi atrás do dinheiro.', es: 'Te quedaste. No fuiste tras el dinero.' }, speed: 50, wait: 1500 },
    { text: { en: 'You could not bring their mother back — but you did not leave them alone.', zh: '你唤不回它们的母亲 —— 但你没有丢下它们。', pt: 'Você não pôde trazer a mãe deles de volta — mas não os deixou sozinhos.', es: 'No pudiste devolverles a su madre — pero no los dejaste solos.' }, speed: 48, wait: 1700 },
    { text: { en: 'Through the long, cold dark, the two cubs pressed together and waited.', zh: '在漫长冰冷的黑里，两只幼崽挤在一起，等着。', pt: 'Pela longa escuridão fria, os dois filhotes se aconchegaram e esperaram.', es: 'A lo largo de la larga y fría oscuridad, los dos cachorros se acurrucaron y esperaron.' }, speed: 48, wait: 1700 },
    { text: { en: 'One kept its eyes open until the sky turned grey.', zh: '有一只，把眼睛睁到天色泛白。', pt: 'Um deles manteve os olhos abertos até o céu clarear.', es: 'Uno mantuvo los ojos abiertos hasta que el cielo se volvió gris.' }, speed: 48, wait: 1800 },
    { text: { en: 'Then — at first light — voices. Footsteps through the wet leaves.', zh: '然后 —— 天刚亮 —— 有人声。脚步踩过湿叶。', pt: 'Então — ao raiar do dia — vozes. Passos sobre as folhas molhadas.', es: 'Entonces — al amanecer — voces. Pasos sobre las hojas mojadas.' }, speed: 48, wait: 1700 },
    { text: { en: 'Not hunters. Rangers — a rescue team, radioed in before dawn.', zh: '不是猎人。是护林员 —— 是天亮前就被叫来的救援队。', pt: 'Não caçadores. Guardas florestais — uma equipe de resgate, chamada antes do amanhecer.', es: 'No cazadores. Guardabosques — un equipo de rescate, llamado antes del alba.' }, speed: 48, wait: 1700 },
    { text: { en: '"Over here — quick — get them warm." Gentle hands lift them from the dark.', zh: '「在这儿 —— 快 —— 给它们保暖。」一双双手，把它们从黑暗里轻轻托起。', pt: '«Aqui — rápido — aqueçam eles.» Mãos gentis os erguem da escuridão.', es: '«Aquí — rápido — abríguenlos.» Manos suaves los levantan de la oscuridad.' }, speed: 46, wait: 1900 },
    { text: { en: 'They lost their mother. But they were not lost. Not this time.', zh: '它们失去了母亲。但它们没有被丢下。这一次，没有。', pt: 'Eles perderam a mãe. Mas não foram perdidos. Não desta vez.', es: 'Perdieron a su madre. Pero no se perdieron. No esta vez.' }, speed: 46, wait: 2600, big: true },
  ];

  /* ============ I18N (EN / 中文) ============ */
  let LANG = 'en';
  const LANGS = ['en', 'zh', 'pt', 'es'];
  try { const s = localStorage.getItem('e6s_lang'); if (LANGS.indexOf(s) !== -1) LANG = s; } catch (_) {}
  ...
  const I18N = {
    ...
    pt: {
      cw: 'AVISO DE CONTEÚDO · 16+',
      warnSub: 'Você será levado a fazer algo<br>que não poderá desfazer.',
      enter: 'Entrar',
      clickContinue: 'Clique para continuar',
      clickShoot: '[ Clique para atirar ]',
      pressEnter: '[ Toque, ou pressione Enter ]',
      learnMore: 'Saiba mais',
      share: 'Compartilhar',
      shareMsg: 'Dei a um filhote de onça o nome {cub}. A cada 6 segundos, um animal morre por nossa causa.',
      copied: 'Copiado',
      references: 'Referências',
      worksCited: 'Obras citadas',
      mla: 'MLA 9ª edição',
      back: 'Voltar',
      rewind: 'Retroceder',
      rewindSub: 'Volte a qualquer momento que você já viu',
      close: 'Fechar',
      openingTagline: 'Uma história que você não deveria ter aberto.',
      skip: 'Pular',
      defaultCub: 'Sol',
      nameLabel: 'Dê um nome a um dos filhotes dela:',
      namePlaceholder: 'Sol',
      saveCard: 'Salvar o cartão',
      cardStayed: 'Você ficou {t}.',
      cardKilled: 'Nesse tempo, cerca de {n} animais selvagens foram mortos.',
      cardNamed: 'Você deu um nome a um deles: {cub}.',
      cardClosing: 'Não sem você.',
      momentLine: 'Guarde este verde.',
      momentLine2: 'Não estará verde quando você voltar.',
      counterTpl: 'Nos <em class="fig">{t}</em> que você passou aqui, cerca de <em class="fig">{n}</em> animais selvagens foram mortos para uso humano.',
      counterNote: 'Uma estimativa ilustrativa (um a cada 6 segundos), baseada em números anuais documentados: até 2,7 milhões de pangolins, ~20.000 elefantes, mais de 1.000 rinocerontes e incontáveis outros. — <a href="https://www.awf.org/blog/27-million-pangolins-are-poached-every-year-scales-and-meat" target="_blank" rel="noopener">AWF</a>',
      choicePrompt: 'Ela ainda não viu você.',
      waitBtn: 'Esperar',
      shootBtn: 'Atirar',
      hbLabel: 'perdidos',
      feedHint: 'Leve-o até a água — toque no rio',
      replayHint: 'Desta vez, a escolha é sua.',
      lowerBtn: 'Abaixar a arma',
      slipBtn: 'Ir embora em silêncio',
      followBtn: 'Seguir a pele',
      stayBtn: 'Ficar com eles',
      forkPrompt: 'Ela se foi. O que você faz agora?',
      deathChar: 'MORTO',
      deathBeat1: 'Um galho seco estalou sob a sua bota.',
      deathBeat2: 'Ela vira a cabeça num átimo. Ela viu você.',
      deathLine: 'Você hesitou — e ela foi mais rápida.',
      unlockTpl: 'FINAL DESBLOQUEADO · 「{name}」',
      rewindChoiceBtn: 'Voltar à escolha',
      restartBtn: 'Do começo',
      continueBtn: 'Seguir a pele',
      namedRecall: 'Você deu a um dos filhotes dela um nome: <span class="cubname">{cub}</span>.',
      fate_xuejia: '{cub} sobreviveu — magro, e sozinho.',
      fate_daijia: 'Eles viveram. Você não.',
      fate_changye: '{cub} foi tirado da escuridão — vivo.',
      fate_kongqiang: 'Outra pessoa puxou o gatilho. {cub} perdeu a mãe do mesmo jeito.',
      fate_poxiao: '{cub} cresceu — em segurança.',
      actBtn: 'O que você pode fazer',
      actTitle: 'O que realmente ajuda',
      act1: 'Nunca compre produtos de animais selvagens — peles, dentes, animais exóticos. Sem demanda, não há matança.',
      act2: 'Apoie quem está na linha de frente — guardas florestais, e grupos como <a href="https://panthera.org" target="_blank" rel="noopener">Panthera</a>, WWF, Rainforest Trust.',
      act3: 'Compartilhe uma história. O jeito mais rápido de um número se tornar real para alguém — é você.',
      actClose: 'Fechar',
      endName_xuejia: 'Dinheiro de Sangue',
      endName_daijia: 'Ajuste de Contas',
      endName_changye: 'Anoitecer',
      endName_kongqiang: 'Vazio',
      endName_poxiao: 'Amanhecer',
      galleryBtn: 'Finais',
      galleryTitle: 'Finais — {n} de 5',
      endLocked: '? ? ?',
      endLockedHint: 'ainda não alcançado',
      cardTag_xuejia: 'Pagou bem. Sempre paga.',
      cardTag_daijia: 'Você hesitou. Ela não.',
      cardTag_changye: 'Perderam a mãe — não um ao outro.',
      cardTag_kongqiang: 'Você foi embora. O relógio não.',
      cardTag_poxiao: 'Este não. Hoje não.',
      saveCardBtn: 'Salvar seu cartão de final',
      cardEndingLbl: 'FINAL — {name}',
      wallBtn: 'O mural de nomes',
      wallLine: 'pessoas deram um nome a um filhote de onça.',
      wallEmpty: 'Ainda sem nomes. O seu pode ser o primeiro.',
      waitLines: ['Você esperou.', 'Mas a pele ainda paga.', 'Seu dedo se moveu mesmo assim.'],
      refuseLines: [
        'Você abaixa o rifle. Você não atira.',
        'Momo ergue a cabeça. Os filhotes somem no verde. Por um instante — eles se foram.',
        'Você deixou esta família viver.',
        'Mas o relógio não esperou com você.',
        'Seis segundos — em algum lugar que você nunca verá, outro caiu.',
        'O rifle ainda está nas suas mãos. Sempre há outra estação. Outro caçador.',
      ],
      guardianBtn: 'Percorrer de novo, como guardião',
      guardHint: 'Mire  ·  toque em cada um para protegê-lo',
      guardResolve: 'Eles vivem. Desta vez, eles vivem.',
      returnBtn: 'Continuar',
      citeJaguar: 'Onças são traficadas por suas peles, dentes e crânios — <a href="https://cites.org/eng/CITES_study_illegal_trade_poaching_jaguar_pantheraonca_2112021" target="_blank" rel="noopener">estudo CITES, 2021</a>',
      hints: {
        intro: 'Clique em qualquer lugar para continuar',
        0: 'Clique em  ENTRAR  para começar',
        1: 'Clique em qualquer lugar para continuar',
        2: 'Clique em qualquer lugar para continuar',
        3: 'Mire  ·  clique ou toque para atirar',
        4: 'Clique em qualquer lugar para continuar',
        5: 'Escolha uma opção abaixo',
        6: 'Clique em  VOLTAR  para retornar',
        7: 'Faça a sua escolha',
        8: 'Clique em qualquer lugar para continuar',
        9: 'Clique em qualquer lugar para continuar',
        10: 'Clique em qualquer lugar para continuar',
        11: 'Mire  ·  toque em cada um para protegê-lo',
        12: 'Clique em qualquer lugar para continuar',
        13: 'Clique em qualquer lugar para continuar',
        14: 'Clique em qualquer lugar para continuar',
        16: 'Absorva  ·  clique quando estiver pronto',
      },
      hintPressEnter: 'Toque, clique ou pressione  ENTER',
      sceneNames: { intro: 'Introdução', 0: 'Aviso', 1: 'Aconchego', 15: 'Ela Também Foi Filhote', 16: 'O Instante', 2: 'O Caçador', 7: 'A Escolha', 3: 'O Tiro', 4: 'O Depois', 8: 'Os Filhotes', 20: 'Anos Depois', 9: 'A Pele', 5: 'A Verdade', 6: 'Fontes', 10: 'O Guardião', 12: 'Vigiar', 13: 'Intervir', 11: 'Proteger', 14: 'Eles Vivem', 21: 'Ajuste de Contas', 22: 'Vazio', 23: 'Anoitecer' },
      sceneDesc: { intro: 'Antes de começar', 0: 'Aviso de conteúdo', 15: 'PARALELA · uma lembrança, uma geração atrás', 20: 'PARALELA · o círculo se fecha, uma geração adiante', 7: 'Uma escolha que nunca foi sua', 3: 'A caçada — você puxa o gatilho', 5: 'A verdade e os dados', 6: 'Obras citadas', 10: 'Percorra de novo, como guardião', 11: 'Você os protege', 21: 'FINAL · você hesitou', 22: 'FINAL · você foi embora', 23: 'FINAL · a primeira noite' },
      reveal: {
        l1: 'Momo não é real.',
        l2: 'Mas a cada 6 segundos, uma de verdade morre.',
        dataIntro: 'Todo ano, caçadores ilegais matam:',
        stats: [
          { num: '20.000', label: 'elefantes — abatidos por suas presas' },
          { num: '1.000+', label: 'rinocerontes — mortos por seus chifres' },
          { num: '2.700.000', label: 'pangolins — esfolados por suas escamas' },
        ],
        unnamed: 'E incontáveis onças, bichos-preguiça, araras — sem nome.',
        brazilIntro: 'Em 2023, a proteção ambiental do Brasil levou a:',
        brazil: [
          'Redução de 50% no desmatamento da Amazônia',
          'Maior devolução de terras a povos indígenas',
          'Fiscalização rigorosa contra a caça ilegal',
        ],
        notEnough: 'Mas não é suficiente.',
        notWithout: 'Não sem você.',
      },
      intro: {
        data: [
          'Leia isto devagar. Nos seis segundos que leva, em algum lugar, uma vida selvagem já se foi.',
          'Até <em class="fig">2,7 milhões de pangolins</em> são caçados a cada ano. Cerca de <em class="fig">20.000 elefantes</em>, pelo marfim. Mais de <em class="fig">mil rinocerontes</em>, pelos chifres — e incontáveis onças, bichos-preguiça e araras que ninguém conta.',
          'Somando tudo, é mais ou menos <em class="fig">uma vida selvagem levada a cada seis segundos.</em>',
        ],
        note: 'Um número desse tamanho perde o sentido. Então tirei uma delas das estatísticas e lhe dei um nome. Ela não é real — os seis segundos são. Não estou pedindo que você se sinta culpado; só não queria que ela continuasse sendo um número.',
      },
    },
    es: {
      cw: 'ADVERTENCIA DE CONTENIDO · 16+',
      warnSub: 'Se te pedirá que hagas algo<br>que no podrás deshacer.',
      enter: 'Entrar',
      clickContinue: 'Haz clic para continuar',
      clickShoot: '[ Haz clic para disparar ]',
      pressEnter: '[ Toca, o pulsa Enter ]',
      learnMore: 'Más información',
      share: 'Compartir',
      shareMsg: 'Le puse {cub} a un cachorro de jaguar. Cada 6 segundos, un animal muere por nuestra culpa.',
      copied: 'Copiado',
      ...
      back: 'Volver',
      rewind: 'Retroceder',
      rewindSub: 'Vuelve a cualquier momento que ya hayas visto',
      close: 'Cerrar',
      openingTagline: 'Una historia que no deberías haber abierto.',
      skip: 'Saltar',
      defaultCub: 'Sol',
      nameLabel: 'Ponle nombre a uno de sus cachorros:',
      namePlaceholder: 'Sol',
      saveCard: 'Guardar la tarjeta',
      cardStayed: 'Te quedaste {t}.',
      cardKilled: 'En ese tiempo, unos {n} animales salvajes fueron asesinados.',
      cardNamed: 'Le diste un nombre a uno de ellos: {cub}.',
      cardClosing: 'No sin ti.',
      momentLine: 'Recuerda este verde.',
      momentLine2: 'Ya no será verde cuando vuelvas.',
      counterTpl: 'En los <em class="fig">{t}</em> que llevas aquí, unos <em class="fig">{n}</em> animales salvajes fueron asesinados para uso humano.',
      counterNote: 'Una estimación ilustrativa (uno cada 6 segundos), basada en cifras anuales documentadas: hasta 2,7 millones de pangolines, ~20.000 elefantes, más de 1.000 rinocerontes e incontables más. — <a href="https://www.awf.org/blog/27-million-pangolins-are-poached-every-year-scales-and-meat" target="_blank" rel="noopener">AWF</a>',
      choicePrompt: 'Ella todavía no te ha visto.',
      waitBtn: 'Esperar',
      shootBtn: 'Disparar',
      hbLabel: 'perdidos',
      feedHint: 'Llévalo al agua — toca el río',
      replayHint: 'Esta vez, la decisión es tuya.',
      lowerBtn: 'Bajar el arma',
      slipBtn: 'Marcharte en silencio',
      followBtn: 'Seguir la piel',
      stayBtn: 'Quedarte con ellos',
      forkPrompt: 'Ella ya no está. ¿Qué haces ahora?',
      deathChar: 'MUERTO',
      deathBeat1: 'Una rama seca se quebró bajo tu bota.',
      deathBeat2: 'Ella gira la cabeza de golpe. Te ha visto.',
      deathLine: 'Dudaste — y ella fue más rápida.',
      unlockTpl: 'FINAL DESBLOQUEADO · 「{name}」',
      rewindChoiceBtn: 'Volver a la decisión',
      restartBtn: 'Desde el principio',
      continueBtn: 'Seguir la piel',
      namedRecall: 'Le diste un nombre a uno de sus cachorros: <span class="cubname">{cub}</span>.',
      fate_xuejia: '{cub} sobrevivió — flaco, y solo.',
      fate_daijia: 'Ellos vivieron. Tú no.',
      fate_changye: 'Sacaron a {cub} de la oscuridad — vivo.',
      fate_kongqiang: 'Otro apretó el gatillo. {cub} perdió a su madre igual.',
      fate_poxiao: '{cub} creció — a salvo.',
      actBtn: 'Lo que puedes hacer',
      actTitle: 'Lo que de verdad ayuda',
      act1: 'Nunca compres productos de animales salvajes — pieles, dientes, mascotas exóticas. Sin demanda, no hay matanza.',
      act2: 'Apoya a quienes están sobre el terreno — guardabosques, y grupos como <a href="https://panthera.org" target="_blank" rel="noopener">Panthera</a>, WWF, Rainforest Trust.',
      act3: 'Comparte una historia. La forma más rápida de que un número se vuelva real para alguien — eres tú.',
      actClose: 'Cerrar',
      endName_xuejia: 'Dinero Sangriento',
      endName_daijia: 'Ajuste de Cuentas',
      endName_changye: 'Anochecer',
      endName_kongqiang: 'Vacío',
      endName_poxiao: 'Amanecer',
      galleryBtn: 'Finales',
      galleryTitle: 'Finales — {n} de 5',
      endLocked: '? ? ?',
      endLockedHint: 'aún no alcanzado',
      cardTag_xuejia: 'Pagó bien. Siempre paga.',
      cardTag_daijia: 'Dudaste. Ella no.',
      cardTag_changye: 'Perdieron a su madre — no el uno al otro.',
      cardTag_kongqiang: 'Te marchaste. El reloj no.',
      cardTag_poxiao: 'Este no. Hoy no.',
      saveCardBtn: 'Guarda tu tarjeta de final',
      cardEndingLbl: 'FINAL — {name}',
      wallBtn: 'El muro de nombres',
      wallLine: 'personas le han puesto nombre a un cachorro de jaguar.',
      wallEmpty: 'Aún no hay nombres. El tuyo podría ser el primero.',
      waitLines: ['Esperaste.', 'Pero la piel sigue pagando.', 'Tu dedo se movió de todos modos.'],
      refuseLines: [
        'Bajas el rifle. No disparas.',
        'Momo levanta la cabeza. Los cachorros se pierden en el verde. Por un instante — ya no están.',
        'Dejaste vivir a esta familia.',
        'Pero el reloj no esperó contigo.',
        'Seis segundos — en algún lugar que nunca verás, otro cayó.',
        'El rifle sigue en tus manos. Siempre hay otra temporada. Otro cazador.',
      ],
      guardianBtn: 'Recorrerlo de nuevo, como guardián',
      guardHint: 'Apunta  ·  toca a cada uno para protegerlo',
      guardResolve: 'Ellos viven. Esta vez, viven.',
      returnBtn: 'Continuar',
      citeJaguar: 'Los jaguares son traficados por su piel, dientes y cráneos — <a href="https://cites.org/eng/CITES_study_illegal_trade_poaching_jaguar_pantheraonca_2112021" target="_blank" rel="noopener">estudio CITES, 2021</a>',
      hints: {
        intro: 'Haz clic en cualquier parte para continuar',
        0: 'Haz clic en  ENTRAR  para empezar',
        1: 'Haz clic en cualquier parte para continuar',
        2: 'Haz clic en cualquier parte para continuar',
        3: 'Apunta  ·  haz clic o toca para disparar',
        4: 'Haz clic en cualquier parte para continuar',
        5: 'Elige una opción abajo',
        6: 'Haz clic en  VOLVER  para regresar',
        7: 'Toma tu decisión',
        8: 'Haz clic en cualquier parte para continuar',
        9: 'Haz clic en cualquier parte para continuar',
        10: 'Haz clic en cualquier parte para continuar',
        11: 'Apunta  ·  toca a cada uno para protegerlo',
        12: 'Haz clic en cualquier parte para continuar',
        13: 'Haz clic en cualquier parte para continuar',
        14: 'Haz clic en cualquier parte para continuar',
        16: 'Tómate tu tiempo  ·  haz clic cuando estés listo',
      },
      hintPressEnter: 'Toca, haz clic o pulsa  ENTER',
      sceneNames: { intro: 'Introducción', 0: 'Advertencia', 1: 'Calidez', 15: 'Ella También Fue Cachorra', 16: 'El Instante', 2: 'El Cazador', 7: 'La Decisión', 3: 'El Disparo', 4: 'Lo Que Vino Después', 8: 'Los Cachorros', 20: 'Años Después', 9: 'La Piel', 5: 'La Verdad', 6: 'Fuentes', 10: 'El Guardián', 12: 'Vigilar', 13: 'Intervenir', 11: 'Proteger', 14: 'Ellos Viven', 21: 'Ajuste de Cuentas', 22: 'Vacío', 23: 'Anochecer' },
      sceneDesc: { intro: 'Antes de empezar', 0: 'Advertencia de contenido', 15: 'PARALELA · un recuerdo, una generación atrás', 20: 'PARALELA · el círculo se cierra, una generación después', 7: 'Una decisión que nunca fue tuya', 3: 'La caza — aprietas el gatillo', 5: 'La verdad y los datos', 6: 'Obras citadas', 10: 'Recórrelo de nuevo, como guardián', 11: 'Los proteges', 21: 'FINAL · dudaste', 22: 'FINAL · te marchaste', 23: 'FINAL · la primera noche' },
      reveal: {
        l1: 'Momo no es real.',
        l2: 'Pero cada 6 segundos, uno de verdad muere.',
        dataIntro: 'Cada año, los cazadores furtivos matan:',
        stats: [
          { num: '20.000', label: 'elefantes — abatidos por sus colmillos' },
          { num: '1.000+', label: 'rinocerontes — muertos por sus cuernos' },
          { num: '2.700.000', label: 'pangolines — desollados por sus escamas' },
        ],
        unnamed: 'E incontables jaguares, perezosos, guacamayos — sin nombre.',
        brazilIntro: 'En 2023, la protección ambiental de Brasil logró:',
        brazil: [
          'Reducción del 50% en la deforestación del Amazonas',
          'La mayor devolución de tierras a pueblos indígenas',
          'Aplicación estricta contra la caza furtiva',
        ],
        notEnough: 'Pero no es suficiente.',
        notWithout: 'No sin ti.',
      },
      intro: {
        data: [
          'Lee esto despacio. En los seis segundos que tarda, en algún lugar, una vida salvaje ya se ha ido.',
          'Hasta <em class="fig">2,7 millones de pangolines</em> son cazados cada año. Unos <em class="fig">20.000 elefantes</em>, por el marfil. Más de <em class="fig">mil rinocerontes</em>, por sus cuernos — e incontables jaguares, perezosos y guacamayos que nadie cuenta.',
          'Sumado todo, es más o menos <em class="fig">una vida salvaje arrebatada cada seis segundos.</em>',
        ],
        note: 'Un número de ese tamaño deja de significar algo. Así que saqué a una de las estadísticas y le di un nombre. Ella no es real — los seis segundos sí. No te pido que te sientas culpable; solo no quería que se quedara siendo un número.',
      },
    },
    zh: {
      cw: '内容警告 · 16+',
